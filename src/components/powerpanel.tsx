  ...
  return (
    ...
    >
      <g fill="none">
        ...
        <g>
          <path
            fill={electric.grid.import > 0 ? color_red : color_green}
          ...
          <g>
            <text
              transform="translate(267.156 518.768)"
              fill={electric.grid.import > 0 ? text_red : text_green}
            >
              <tspan
                fontFamily="Helvetica Neue"
                fontSize={16}
        ...
        <g>
          <path
            fill={power_colour(electric.location.use, 3000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.flat.use, 3000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.use, 3000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.fuseboxes[2].use, 3000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.fuseboxes[1].use, 3000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.fuseboxes[0].use, 3000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.smartplugs[0].use, 1000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.smartplugs[1].use, 1000)}
        ...
        <g>
          <path
            fill={power_colour(electric.location.house.smartplugs[2].use, 1000)}
